...
app.post('/inquiry', function(req, res){
  ...
  // Ignore is supposed to allow repeat information to be ignored 
  var query = connection.query('INSERT IGNORE INTO inquiries SET ?', inquiry, function(err, result){
    if(!err){
...
app.get('/query', function(req, res){
  ...
  // DISTINCT allows you to ignore repeat information
  connection.query('SELECT DISTINCT FirstName, LastName, Email FROM inquiries', function(err, rows, fields){
